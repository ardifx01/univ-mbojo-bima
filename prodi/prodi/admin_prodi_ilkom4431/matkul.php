...
<body>
    <div class="wrapper">
        ...
        <div class="main p-3">
            ...
            <div data-bs-spy="scroll" data-bs-root-margin="0px 0px 40%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary rounded-2" tabindex="0" >
                ...
                <?php
                $sql = "SELECT * FROM mata_kuliah WHERE kode_prodi = 'P002'";
                $hasil = $con->query($sql);
                if ($hasil == FALSE){
