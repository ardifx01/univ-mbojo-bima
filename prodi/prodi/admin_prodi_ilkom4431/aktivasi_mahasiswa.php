...
<body>
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <!--view data-->
            <div class="py-3 px-3">
                <table class="table datatable table-sm" style="font-size:13px;">
                <thead class="text-center" style="background-color: #d3bf0a; font-size: 14px;">
                    ...
                    <th class="text-center">Aktif Prodi</th>
                    <th>Aksi</th>
                </thead>
                <?php
                $sql = "SELECT * FROM mahasiswa WHERE jurusan='P002' ORDER BY id_mahasiswa ASC";
                $hasil = $con->query($sql);
                if ($hasil == FALSE){
