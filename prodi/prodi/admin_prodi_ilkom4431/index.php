              ...
              <div class="card info-card sales-card">
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <?php
                      $data_dosen = mysqli_query($con,"SELECT * FROM tabel_dosen WHERE prodi = 'P002'");
              ...
              <div class="card info-card revenue-card">
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <?php
                      $data_mahasiswa = mysqli_query($con,"SELECT * FROM mahasiswa WHERE jurusan = 'P002'");
              ...
              <div class="card info-card sales-card">
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <?php
                      $data_matkul = mysqli_query($con,"SELECT * FROM mata_kuliah WHERE kode_prodi = 'P002'");
              ...
              <div class="card info-card revenue-card">
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <?php
                      $data_mahasiswa = mysqli_query($con,"SELECT * FROM mahasiswa WHERE jurusan = 'P002' and ket_aktif = 'Y'");
                      $jml_mahasiswa = mysqli_num_rows($data_mahasiswa);
              ...
              <div class="card info-card revenue-card">
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <?php
                      $data_mahasiswa = mysqli_query($con,"SELECT * FROM mahasiswa WHERE jurusan = 'P002' and ket_aktif = 'T'");
                      $jml_mahasiswa = mysqli_num_rows($data_mahasiswa);
