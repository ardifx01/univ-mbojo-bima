                                ...
                                <div class="modal-body">
                                    <select name="id_mata_kuliah" class="form-control mb-3" >
                                        ...
                                        if ($semester_akademik == "ganjil") {
                                            $sql = "SELECT * FROM mata_kuliah WHERE kode_prodi = 'P001' && semester IN('1','3','5','7')  ";
                                            $hasil = $con->query($sql);
                                            if ($hasil == FALSE){
                                                trigger_error("Syntax mysql salah : ".$sql."Error: ".$con->error, E_USER_ERROR);
                                            }else{
                                            ...
                                            $sql = "SELECT * FROM mata_kuliah WHERE kode_prodi = 'P001' && semester IN('2','4','6','8')  ";
                                            $hasil = $con->query($sql);
                                            if ($hasil == FALSE){
                                                trigger_error("Syntax mysql salah : ".$sql."Error: ".$con->error, E_USER_ERROR);
                                            }else{
                                    ...
                                    <?php
                                        $sql = "SELECT * FROM prodi WHERE kode ='P001'";
                                        $hasil = $con->query($sql);
                                        if ($hasil == FALSE){
                                            trigger_error("Syntax mysql salah : ".$sql."Error: ".$con->error, E_USER_ERROR);
                                        }else{
