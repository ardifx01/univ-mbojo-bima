                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-6 text-right">
                        <a href="print_ringkas_pdf.php?bulan=<?php echo $_GET['bulan'] ?>" type="button" class="btn btn-danger btn-rounded btn-fw">print PDF</a>
                        <a href="print_ringkas_exel.php?bulan=<?php echo $_GET['bulan'] ?>" type="button" class="btn btn-success btn-rounded btn-fw">print EXEL</a>
                      </div>
                    </div>
                    </p>
                            ...
                            while ($h = $hasil->fetch_array()) {
                              ...
                              <tr> 
                                <tr>                                  
                                  ...
                                  <td><a href="rekap_absen.php?dosen=<?php echo $h['id_dosen']; ?>&bulan=<?php echo $_GET['bulan'] ?>">Detail</td>
                                </tr>
                                <?php 
                              }
                            }
