    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item"> <a class="nav-link" href="pages/ui-features/dropdowns.html">Rekap Absensi</a></li>
        </ul>
      </div>
    </li>
  </ul>
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tbody>
                          <?php
                          $sql = "SELECT * FROM absensi_dosen INNER JOIN tabel_dosen ON absensi_dosen.id_dosen = tabel_dosen.id_dosen";
                          $hasil = $con->query($sql);
                          $no=1;
                          if ($hasil == FALSE){
                            ...
                            while ($h = $hasil->fetch_array()) {?>
                              <tr>
                                <tr>
                                  ...
                                  <td class="py-1">
                                    <img src="../upload/<?php echo $h['foto'] ?>" alt="image" />
                                  </td>
                                </tr>
                                <?php
                              }
