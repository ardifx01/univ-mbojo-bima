    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="pilih_bulan_dosen.php">Pilih Bulan</a></li>
        </ul>
      </div>
    </li>
  </ul>
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tbody>
                          <?php
                          $bulan = $_GET['bulan'];
                          $sql = "SELECT * FROM absensi_dosen INNER JOIN tabel_dosen ON absensi_dosen.id_dosen = tabel_dosen.id_dosen WHERE absensi_dosen.bulan_absensi = $bulan and absensi_dosen.id_tahun = $tahun and absensi_dosen.id_dosen = $id_dosen";
                          $hasil = $con->query($sql);
                          $no=1;
                          if ($hasil == FALSE){
                            trigger_error("Syntax mysql salah : ".$sql."Error: ".$con->error, E_USER_ERROR);
                            ...
                            while ($h = $hasil->fetch_array()) {?> 
                              <tr> 
                                <tr> 
                                  ...
                                  <td><a class="btn btn-sm btn-danger" name="hapus" href="hapus_absen.php?hapus=<?php echo $h['id_absensi']?>&bulan=<?php echo $bulan ?>">hapus</a></td>
                                </tr>
                                <?php 
                              }
                            }
