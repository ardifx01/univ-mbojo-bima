    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item"> <a class="nav-link" href="#">Rekap Absensi</a></li>
        </ul>
      </div>
    </li>
  </ul>
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive pt-3">
                      <table class="table table-bordered text text-center">
                        <tbody>
                          <tr>
                            <td><a href="rekap_absen_dosen.php?bulan=01">Januari</a></td>
                            <td><a href="rekap_absen_dosen.php?bulan=02">Februari</a></td>
                            <td><a href="rekap_absen_dosen.php?bulan=03">Maret</a></td>                            
                          </tr>
                          <tr>
                            <td><a href="rekap_absen_dosen.php?bulan=04">April</a></td>
                            <td><a href="rekap_absen_dosen.php?bulan=05">Mei</a></td>
                            <td><a href="rekap_absen_dosen.php?bulan=06">Juni</a></td>
                          </tr> 
                          <tr>
                            <td><a href="rekap_absen_dosen.php?bulan=07">Juli</a></td>
                            <td><a href="rekap_absen_dosen.php?bulan=08">Agustus</a></td>
                            <td><a href="rekap_absen_dosen.php?bulan=09">September</a></td>
                          </tr>
                          <tr>
                            <td><a href="rekap_absen_dosen.php?bulan=10">Oktober</a></td>
                            <td><a href="rekap_absen_dosen.php?bulan=11">November</a></td>
                            <td><a href="rekap_absen_dosen.php?bulan=12">Desember</a></td>
                          </tr>                        
                        </tbody>
                      </table>
                    </div>
