  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          <li><a href="humas/home.php">Home</a></li>
          <li><a href="#" class="active">Input Berita</a></li>
          <li><a href="humas/input_jurnal.php">Input Jurnal</a></li>
        </ul>
        <i class="mobile-nav-toggle d-xl-none bi bi-list"></i>
      </nav>

      <a class="btn-getstarted" href="humas/logout_humas.php">logout</a>
      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Berita Page</h1>
              <p class="mb-0">Tempat untuk admin unggah berita</p>
            </div>
          </div>
        </div>
      </div>
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Berita Page</li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="container" data-aos="fade-up">
        <section id="contact" class="contact section">
          ...
          <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="row gy-4">
              <div class="col-lg">
                <form action="proses_input_berita.php" method="post" data-aos="fade-up" data-aos-delay="200" enctype="multipart/form-data">
                  <div class="row gy-4">
                    ...
                    <div class="col-md-12">
                      <textarea class="form-control" name="isi_paragraf_1" rows="6" placeholder="paragraf 1" required=""></textarea>
                    </div>
                    <div class="col-md-12">
                      <textarea class="form-control" name="isi_paragraf_2" rows="6" placeholder="paragraf 2" required=""></textarea>
                    </div>
                    <div class="col-md-12">
                      <textarea class="form-control" name="isi_paragraf_3" rows="6" placeholder="paragraf 3" required=""></textarea>
                    </div>
                    <div class="col-md-12">
                      <textarea class="form-control" name="penutup" rows="6" placeholder="peutup" required=""></textarea>
                    </div>
                    ...
                    <div class="col-md-12 text-center">
                      ...
                      <button class="btn btn-outline-success" type="submit" value="simpan" name="upload">Upload Berita</button>
                    </div>
